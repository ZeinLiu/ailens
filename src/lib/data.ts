...
export const PROJECTS: Project[] = [
  {
    ...
    tagline: "Stop ctrl+F searching through hundreds of pages. Upload your PDFs, ask in plain English, get the answer with the exact source — runs fully on your machine.",
    source: { author: "LangChain team", platform: "LangChain docs", url: "https://python.langchain.com/docs/tutorials/rag/" },
    difficulty: "Beginner",
    categories: ["RAG"],
...
def query(q: Query):
  ...
  {
    id: 2, num: "02", title: "Build an AI that searches, calculates, and takes actions on your behalf",
    tagline: "Give an LLM real tools — web search, a calculator, live APIs — and watch it reason through multi-step problems without you lifting a finger.",
    source: { author: "Simon Willison", platform: "X / Blog", url: "https://simonwillison.net" },
  ...
  {
    id: 3, num: "03", title: "Ship a live AI chat assistant in an afternoon — with streaming and memory",
    tagline: "No backend expertise needed. Build a chat UI where responses stream word-by-word and the bot remembers what you said — deployed to a real URL with one command.",
    source: { author: "Vercel AI SDK team", platform: "Vercel Docs", url: "https://sdk.vercel.ai/docs" },
  ...
  {
    id: 4, num: "04", title: "Train a private AI model that outperforms ChatGPT on your specific task",
    tagline: "A general LLM is a generalist. A fine-tuned model trained on your data beats it every time on your task — at a fraction of the inference cost, running entirely on your own hardware.",
    source: { author: "Sebastian Raschka", platform: "Magazine / X", url: "https://magazine.sebastianraschka.com" },
  ...
  {
    id: 5, num: "05", title: "Build an AI that reads screenshots, charts, and documents like a human would",
    tagline: "Point a vision model at any image — a UI screenshot, a bar chart, a scanned form — and get back structured answers, extracted data, or a description of what's wrong.",
    source: { author: "Greg Kamradt", platform: "YouTube / X", url: "https://www.youtube.com/@DataIndependent" },
  ...
  {
    id: 6, num: "06", title: "Turn any meeting recording into structured notes and action items automatically",
    tagline: "Stop taking notes during calls. Record, transcribe with Whisper, and get a clean summary with decisions made, owners named, and deadlines captured — delivered to Slack before the meeting ends.",
    source: { author: "Swyx (Shawn Wang)", platform: "Latent Space Podcast / X", url: "https://www.latent.space" },
  ...
  {
    id: 7, num: "07", title: "Replace hours of manual monitoring with an AI workflow that runs itself",
    tagline: "Pick any repetitive task — check this page, summarise what changed, tell me on Slack. Chain it into a scheduled flow that runs without you. No backend, no code if you use n8n.",
    source: { author: "Ben Tossell", platform: "Ben's Bites Newsletter", url: "https://bensbites.com" },
  ...
  {
    id: 8, num: "08", title: "Build search that understands meaning, not just keywords",
    tagline: "Keyword search fails when users phrase things differently. Vector search finds what they mean, even when the words don't match. Add reranking and you beat Google-level search in an afternoon.",
    source: { author: "Jason Liu", platform: "X / Instructor Docs", url: "https://jxnl.github.io/instructor" },
  ...
  {
    id: 9, num: "09", title: "Stop guessing which AI prompt works — measure and compare them quantitatively",
    tagline: "Every team changes prompts by gut feel and hopes things got better. Build a graded test set, an LLM-as-judge scorer, and a CI gate — so you know for certain before you ship.",
    source: { author: "Hamel Husain", platform: "Blog / X", url: "https://hamel.dev" },
